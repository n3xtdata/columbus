...
//
//    GenericYamlLoader<ColumbusFile> checkFileLoader = new GenericYamlLoader<>(new ColumbusFile());
//
//    Multimap<String, ColumbusFile> allObjects = checkFileLoader
//        .load("src/test/resources/generic-yaml-loader-tests/checks/test1.yml");
//
//    ColumbusFile columbusFile = allObjects.get("check").iterator().next();
//    assertEquals("check", columbusFile.getKind());
//  }
//
//  @Test
